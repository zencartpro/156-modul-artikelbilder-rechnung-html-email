 ...
 * @version $Id: tpl_account_history_info_default.php mit Artikelbildern 2020-07-23 16:12:16Z webchills $
 */
?>
...
<?php
  ...
  ?>
    <tr>
	  	<!--JT mod - Product Image-->
        <td class="accountQuantityDisplay"><?php echo (zen_get_products_image($order->products[$i]['id'], IMAGE_ON_INVOICE_IMAGE_WIDTH, IMAGE_ON_INVOICE_IMAGE_HEIGHT)); ?></td>
		<!--JT mod - Product Image-->  
